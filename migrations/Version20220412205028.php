 ...
 */
final class Version20220412205028 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement CHANGE id_transport id_transport INT NOT NULL, CHANGE id_hebergement id_hebergement INT NOT NULL, CHANGE id_user id_user INT NOT NULL, CHANGE id_equipement id_equipement INT NOT NULL');
        $this->addSql('ALTER TABLE ligne_commande CHANGE id_equipement id_equipement INT NOT NULL, CHANGE id_commande id_commande INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE reservationevenement CHANGE id_evenement id_evenement INT NOT NULL, CHANGE id_h id_h INT NOT NULL');
