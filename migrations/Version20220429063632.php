 ...
 */
final class Version20220429063632 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id_transport INT DEFAULT NULL, id_avis INT DEFAULT NULL, id_hebergement INT DEFAULT NULL, id_user INT DEFAULT NULL, id_equipement INT DEFAULT NULL, id_Event INT AUTO_INCREMENT NOT NULL, nom_Event VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date_debut VARCHAR(255) NOT NULL, date_fin VARCHAR(255) NOT NULL, nbr_reservation INT NOT NULL, prix INT NOT NULL, activite VARCHAR(255) NOT NULL, INDEX id_equipement (id_equipement), INDEX id_transport (id_transport), INDEX id_avis (id_avis), INDEX id_hebergement (id_hebergement), INDEX id_user (id_user), PRIMARY KEY(id_Event)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE hebergement (id_h INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, ville VARCHAR(20) NOT NULL, categorie VARCHAR(20) NOT NULL, capacite INT NOT NULL, disponibilite TINYINT(1) NOT NULL, prix INT NOT NULL, PRIMARY KEY(id_h)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE moyen_transport (id_transport INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, matricule VARCHAR(255) NOT NULL, marque VARCHAR(255) NOT NULL, nbr_place INT NOT NULL, frais DOUBLE PRECISION NOT NULL, UNIQUE INDEX matricule (matricule), PRIMARY KEY(id_transport)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE participement_event (id_participement INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, nbr_participement INT NOT NULL, id_Event INT DEFAULT NULL, INDEX id_user (id_user), INDEX id_Event (id_Event), PRIMARY KEY(id_participement)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation_moyen_transport (id_reservation INT AUTO_INCREMENT NOT NULL, id_transport INT NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, place VARCHAR(255) NOT NULL, PRIMARY KEY(id_reservation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservationsimple (id_rs INT AUTO_INCREMENT NOT NULL, id_h INT DEFAULT NULL, dateDebut DATE NOT NULL, dateFin DATE NOT NULL, INDEX id_h (id_h), PRIMARY KEY(id_rs)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateurs (id_user INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, num_tel INT NOT NULL, login VARCHAR(255) NOT NULL, mdp VARCHAR(255) NOT NULL, role LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', is_active TINYINT(1) NOT NULL, PRIMARY KEY(id_user)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE participement_event ADD CONSTRAINT FK_B6206E8614EA6493 FOREIGN KEY (id_Event) REFERENCES evenement (id_Event)');
