 ...
 * Evenement
 *
 * @ORM\Table(name="evenement", indexes={@ORM\Index(name="id_user", columns={"id_user"}), @ORM\Index(name="id_equipement", columns={"id_equipement"}), @ORM\Index(name="id_hebergement", columns={"id_hebergement"}), @ORM\Index(name="id_transport", columns={"id_transport"}), @ORM\Index(name="id_avis", columns={"id_avis"})})
 * @ORM\Entity
 */
class Evenement
{
