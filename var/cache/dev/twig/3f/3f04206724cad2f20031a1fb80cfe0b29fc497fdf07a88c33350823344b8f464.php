...
class __TwigTemplate_f352a100a66484413f380ac7fbdf3ad6244a5ba17988895daa35fb3df8bf9193 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["reclamation"]) {
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reclamation"], "photo", [], "any", false, false, false, 22), "html", null, true);
            echo "\" width=\"100\"></td>
                <td>";
            // line 23
            ...
            echo "</td>
                <td>";
            // line 24
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["reclamation"], "idu", [], "any", false, false, false, 24), "nom", [], "any", false, false, false, 24), "html", null, true);
            echo "</td>
                <td>";
            // line 25
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reclamation"], "etat", [], "any", false, false, false, 25), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"#\" class=\"btn btn-primary\">Traité</a>
                </td>
            </tr>
        ";
...
";
    ...
    {
        return array (  133 => 35,  124 => 31,  113 => 25,  109 => 24,  105 => 23,  100 => 22,  96 => 21,  93 => 20,  88 => 19,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
    ...
    <table class=\"table\">
        ...
        {% for reclamation in reclamations %}
            <tr>
                ...
                <td><img src=\"{{ asset('Upload/')}}{{ reclamation.photo }}\" width=\"100\"></td>
                <td>{{ reclamation.date ? reclamation.date|date('Y-m-d') : '' }}</td>
                <td>{{ reclamation.idu.nom }}</td>
